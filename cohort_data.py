...
def sort_by_cohort(filename):
    ...
    for line in data:
        data_lst = line.split("|")
        if data_lst[-1][1] == 'p':
            spring_16.append(data_lst[0] + " " + data_lst[1])
        elif data_lst[-1][1] == 'u':
            summer_16.append(data_lst[0] + " " + data_lst[1])
        elif data_lst[-1][1] == 'a':
            fall_15.append(data_lst[0] + " " + data_lst[1])
        elif data_lst[-1][1] == 'i':
            winter_16.append(data_lst[0] + " " + data_lst[1])
        elif data_lst[-1][0] == 'G':
            ghosts.append(data_lst[0] + " " + data_lst[1])
...
def hogwarts_by_house(filename):
    ...
    for line in data:
        data_lst = line.split("|")
        if data_lst[-1][0] == 'I':
            instructors.append(data_lst[1])
        elif data_lst[-1][0] == 'G':
            ghosts.append(data_lst[1])    
        elif data_lst[2][0] == 'G':
            gryffindor.append(data_lst[1])
        elif data_lst[2][0] == 'H':
            hufflepuff.append(data_lst[1])
        elif data_lst[2][0] == 'S':
            slytherin.append(data_lst[1])
        elif data_lst[2][0] == 'D':
            dumbledores_army.append(data_lst[1])
        elif data_lst[2][0] == 'R':
            ravenclaw.append(data_lst[1])         
...
def all_students_tuple_list(filename):
    ...
    for line in data:
        data_lst = data_lst.rstrip()
        data_lst = data_lst.rstrip()
        data_lst = line.split("|")


        student_list.append(tuple(data_lst))
